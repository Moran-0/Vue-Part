<template>
  <div>
    ...
    <div style="padding:10px">
      <el-input style="width:250px;margin-left:40px " suffix-icon="el-icon-search" placeholder="请输入账号搜索" v-model="load.userId"></el-input>
      <el-input style="width:250px;margin-left:40px " suffix-icon="el-icon-search" placeholder="请输入门店搜索"v-model="load.shopId"></el-input>
    ...
    <el-table :data="load" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55"></el-table-column>



      <el-table-column prop="userId" label="员工账号" text-align:center  width="170">
      </el-table-column>
      <el-table-column prop="userName" label="员工姓名" text-align:center width="170">
      </el-table-column>

      <el-table-column prop="shopId" label="所属门店" text-align:center width="210">
      </el-table-column>
      ...
      <el-table-column prop="password" label="员工密码" text-align:center width="170">
    </el-table-column>
